...
server = 'tcp:grammys-db.database.windows.net' 
database = 'db-g-chango'
username = 'user'
password = '1234Chango'
...
params = urllib.parse.quote_plus(r'Driver={ODBC Driver 17 for SQL Server};Server=tcp:grammys-db.database.windows.net,1433;Database=db-g-chango;Uid=user@grammys-db.database.windows.net;Pwd=1234Chango;Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;')#write the DataFrame to a table in the sql database
